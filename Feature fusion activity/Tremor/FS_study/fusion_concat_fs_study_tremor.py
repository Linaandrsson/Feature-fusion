...
# Reproducibility
# -------------------------------
SEED = [30]   # single int or list of ints
...
EMBEDDINGS_FOLDER_NAME = "ExtractedFeatures_clean"

# -------------------------------
# Sensors + FS study setup
# -------------------------------
FIXED_SENSORS = ["Acc_ankle", "Gyro_arm", "Mag_ankle", "Mag_arm"]  # Fixed sensor set for all experiments (3-sensor combos)  
FS_CANDIDATES = [10, 20, 30, 40, 50]
MAX_COMBOS = None
SKIP_EXISTING = True

# -----------------------------------------------------------------------
# Scenario configuration  (mirrors ablation study logic)
# -----------------------------------------------------------------------
...
# -----------------------------------------------------------------------
TRAIN_TREMOR_TYPES = ["tremor_clean"]   # clean only
TEST_TREMOR_TYPES  = ["tremor_clean"]   # clean only
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Tremor FS combination study")
