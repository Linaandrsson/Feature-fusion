...
Run alongside GPU1 script without any crossover:
  python fusion_concat_fs_study_tremor_GPU0.py   # Tremor→Tremor on cuda:0
...
# -------------------------------
FIXED_SENSORS = ["Acc_ankle", "Gyro_arm", "Mag_ankle", "Mag_arm"]
...
# -------------------------------
# Logging — GPU0-specific directory and filename
# -------------------------------
LOG_DIR = SCRIPT_DIR / "tremor_logs_gpu0"
LOG_DIR.mkdir(parents=True, exist_ok=True)
LOG_FILE = LOG_DIR / "tremor_fusion_fs_combo_study_clean_clean.jsonl"
