...
#tremor_variants = ["s4_w4_fs50_tremor_clean", "S4_W4_fs50_tremor_clean_awgn", "s4_w4_fs50_tremor_clean_rotation"]  # mixed
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tag", type=str, default=None,
                        help="Override ABLATION_REPORT_TAG (e.g. --tag mixed)")
    parser.add_argument("--variants", type=str, default=None,
                        help="Override tremor_variants as comma-separated list "
                             "(e.g. --variants s4_w4_fs50_tremor_clean,s4_w4_fs50_tremor_clean_awgn)")
    ...
    if args.tag is not None:
        ABLATION_REPORT_TAG = args.tag
    if args.variants is not None:
        tremor_variants = [v.strip() for v in args.variants.split(",")]
    main()
