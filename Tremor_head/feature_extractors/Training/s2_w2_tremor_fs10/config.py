# Configuration for s2_w2_tremor_fs10 feature extractor training
...
variant_names = ["s2_w2_fs10_tremor_clean", "s2_w2_fs10_tremor_mild_mod", "s2_w2_fs10_tremor_mod_severe"]

# Model variant name (sampling frequency + dataset mix)
model_variant = "fs10_mixed"  # fs10 = 10Hz, mixed = clean + mild_mod + mod_severe

# Sequence length
seq_len = 2*10  # 10Hz * 2s window = 20 samples
# ====================================================================
