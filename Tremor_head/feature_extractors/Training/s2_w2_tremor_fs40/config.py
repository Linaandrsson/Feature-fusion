...
variant_names = ["s2_w2_fs40_tremor_clean", "s2_w2_fs40_tremor_mild_mod", "s2_w2_fs40_tremor_mod_severe"]

# Model variant name (sampling frequency + dataset mix)
model_variant = "fs40_mixed"  # fs40 = 40Hz, mixed = clean + mild_mod + mod_severe

# Sequence length
seq_len = 2*40  # 40Hz * 2s window = 80 samples
# ====================================================================
