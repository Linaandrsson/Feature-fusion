...
variant_names = ["s2_w2_fs30_tremor_clean", "s2_w2_fs30_tremor_mild_mod", "s2_w2_fs30_tremor_mod_severe"]

# Model variant name (sampling frequency + dataset mix)
model_variant = "fs30_mixed"  # fs30 = 30Hz, mixed = clean + mild_mod + mod_severe

# Sequence length
seq_len = 2*30  # 30Hz * 2s window = 60 samples
# ====================================================================
