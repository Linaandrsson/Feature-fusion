...
SAMPLING_FREQ = [30, 50]  # Acc_arm: 30 Hz, Gyro_arm: 50 Hz
...
# Logging
LOG_DIR = WORKSPACE_ROOT / "Tremor_head" / "fusion" / "logs" / freq_str
LOG_DIR.mkdir(parents=True, exist_ok=True)
PLOT_DIR = WORKSPACE_ROOT / "Tremor_head" / "fusion" / "plots" / freq_str
PLOT_DIR.mkdir(parents=True, exist_ok=True)
LOG_FILE = LOG_DIR / "feature_fusion_training.jsonl"

# Model paths
MODEL_DIR = WORKSPACE_ROOT / "Tremor_head" / "fusion" / "models" / freq_str
