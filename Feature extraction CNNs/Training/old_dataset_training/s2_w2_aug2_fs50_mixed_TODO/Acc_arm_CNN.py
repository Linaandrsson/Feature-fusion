...
# Save SEPARATE embeddings for each variant in their respective folders
...
for variant_dir in variant_dirs:
    ...
    # Generate or load train/val/test splits FOR THIS VARIANT (based on 3313 samples)
    ...
    if not (variant_split_dir / "train_idx.txt").exists():
        # Generate splits for this variant (same ratio as combined: 70/15/15)
        ...
        # Load existing splits to ensure consistency across sensors for this variant
