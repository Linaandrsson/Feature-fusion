...
variant_names = [
    "s2_w2_fs20_tremor_clean",       # No tremor (100% score=0)
    "s2_w2_fs20_tremor_mild_mod",    # Mild tremor (50% score=1, 50% score=2)
    "s2_w2_fs20_tremor_mod_severe"   # Severe tremor (50% score=3, 50% score=4)
]
