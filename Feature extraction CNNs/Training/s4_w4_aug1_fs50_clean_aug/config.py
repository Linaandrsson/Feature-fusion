...
variant_names = [
    ...
    "s4_w4_fs50_tremor_clean_awgn",  # Mild tremor (100% score=1)
    "s4_w4_fs50_tremor_clean_rotation",  # Moderate tremor (100% score=2)
]
...
output_variant_name = "fs50_tremor_clean_aug"  # Combined output from all 3 augmentations
# ====================================================================
