...
variant_name = "fs20_clean"  # Change this to train on different variant (train on clean sets)
...
feature_extraction_root = script_dir.parent.parent  # Training/s_w_aug_fs -> Training -> Feature extraction CNNs
