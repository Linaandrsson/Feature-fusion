...
variant_names = [
    "s2_w2_fs30_tremor_clean",       # No tremor (100% score=0)
    "s2_w2_fs30_tremor_mild_mod",    # Mild tremor (50% score=1, 50% score=2)
    "s2_w2_fs30_tremor_mod_severe"   # Severe tremor (50% score=3, 50% score=4)
]
...
feature_extraction_root = script_dir.parent.parent  # Training/s2_w2_aug2_fs30_mixed_TODO -> Training -> Feature extraction CNNs
output_variant_name = "fs30_tremor_mixed_all3"  # Combined output from all 3 augmentations
