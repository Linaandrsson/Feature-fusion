...
variant_names = [
    "s4_w4_fs30_tremor_clean",       # No tremor (100% score=0)
    "s4_w4_fs30_tremor_mild_mod",    # Mild tremor (50% score=1, 50% score=2)
    "s4_w4_fs30_tremor_mod_severe"   # Severe tremor (50% score=3, 50% score=4)
]

# Sequence length
seq_len = 120  # fs*s (30 Hz × 4s = 120 samples)
