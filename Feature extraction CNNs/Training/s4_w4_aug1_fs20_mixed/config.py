...
variant_names = [
    "s4_w4_fs20_tremor_clean",       # No tremor (100% score=0)
    "s4_w4_fs20_tremor_mild_mod",    # Mild tremor (50% score=1, 50% score=2)
    "s4_w4_fs20_tremor_mod_severe"   # Severe tremor (50% score=3, 50% score=4)
]

# Sequence length
seq_len = 80  # fs*s (20 Hz × 4s = 80 samples)

# Output variant name (used for saving models and embeddings)
output_variant_name = "fs20_tremor_mixed_all3"  # Combined output from all 3 augmentations
# ====================================================================
