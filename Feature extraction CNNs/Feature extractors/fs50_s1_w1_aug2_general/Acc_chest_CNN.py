...
from config import base_dir, seq_len, get_ckpt_path, out_dir

# --- CONFIG ---
sensor_name = "Acc_chest"
num_channels = 3
batch_size = 256
...
# --- Define the SAME model class as in Acc_chest_CNN.py (clean version) ---
...
# --- Save in the same folder as the dataset ---
