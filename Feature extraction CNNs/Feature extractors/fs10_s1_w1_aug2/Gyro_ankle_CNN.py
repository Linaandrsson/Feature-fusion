...
# Config
# -------------------------------
file_path = "/Users/linaandersson/Library/CloudStorage/OneDrive-NTNU/master/Code/data/Datagenerator_files/fs10_s1_w1_aug2/Gyro_ankle.txt"
...
sensor_name = Path(file_path).stem  # "Gyro_ankle"
