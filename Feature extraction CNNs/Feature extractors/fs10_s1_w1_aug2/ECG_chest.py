...
# Config
# -------------------------------
file_path = "/Users/linaandersson/Library/CloudStorage/OneDrive-NTNU/master/Code/data/Datagenerator_files/fs10_s1_w1_aug2/ECG.txt"
...
seq_len = 10
num_channels = 2  # ECG has 2 leads
...
sensor_name = Path(file_path).stem  # "ECG"
