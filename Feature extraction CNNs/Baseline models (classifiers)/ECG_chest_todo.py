...
save_dir = Path("Baseline models")
save_dir.mkdir(parents=True, exist_ok=True)
sensor_name = Path(file_path).stem  # e.g. "Gyro_arm"
save_path = save_dir / f"baseline_{sensor_name}_cnn.pth"
...
# Confusion Matrix
# -------------------------------
labels_display = list(range(1, 13))  # 1..12
