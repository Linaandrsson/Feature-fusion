...
variant_names = [
    "s4_w4_fs50_tremor_clean",       # No tremor (100% score=0)
    "s4_w4_fs50_tremor_mild_mod",    # Mild tremor (50% score=1, 50% score=2)
    "s4_w4_fs50_tremor_mod_severe"   # Severe tremor (50% score=3, 50% score=4)
]

# Sequence length
seq_len = 200  # fs*s (50 Hz × 4s = 200 samples)
...
# ============================================================
# SUBJECT-BASED TRAIN/VAL/TEST SPLITS
# ============================================================
# Parkinson data mapping:
#  - CT subjects: 1-19 (19 control subjects)
#  - PD subjects: 101-114 (14 Parkinson disease subjects in separate variant)
#
# NOTE: The 3 tremor variants (clean, mild_mod, mod_severe) use ONLY CT subjects
# PD subjects are in a separate variant: s4_w4_fs50_tremor_parkinson
#
# Using subject-based splits to prevent data leakage (all windows from same subject in same fold)
