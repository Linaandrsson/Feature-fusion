...
ALL_SENSORS = ["Acc_ankle", "Acc_arm", "Acc_chest", "Gyro_ankle", "Gyro_arm", "Mag_ankle", "Mag_arm", "ECG"]
...
# -------------------------------
ABLATION_K = [5]  # List of subset sizes to test (e.g., [2, 3] tests all 2-sensor and 3-sensor combos)
...
# -------------------------------
# Use script's directory as base for logs and plots
SCRIPT_DIR = Path(__file__).parent

SAVE_PLOTS = True
PLOT_DIR = SCRIPT_DIR / "ablation_plots"
