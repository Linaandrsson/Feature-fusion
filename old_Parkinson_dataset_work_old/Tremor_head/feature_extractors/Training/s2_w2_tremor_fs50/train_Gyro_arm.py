"""
Tremor Feature Extractor Training: Gyro_arm CNN
================================================

Trains a CNN feature extractor for Gyro_arm sensor on tremor dataset.
...
class GyroArmFeatureExtractor(nn.Module):
    """
    CNN feature extractor for Gyro_arm sensor.
