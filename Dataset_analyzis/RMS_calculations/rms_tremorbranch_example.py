"""
Quick RMS Calculation Example for Tremor-Branch Dataset
========================================================

This script demonstrates how to calculate RMS values for tremor-branch data
programmatically without interactive prompts.

Tremor-branch sensors (non-normalized for tremor estimation):
- Acc_arm_tremorbranch
- Gyro_arm_tremorbranch

These signals preserve amplitude information (no z-score normalization)
needed for tremor severity estimation.

Modify the parameters below and run:
    python rms_tremorbranch_example.py
"""

from calculate_rms_tremorbranch import (
    get_activity_window, 
    calculate_all_rms, 
    print_rms_results,
    export_rms_to_txt,
...
if __name__ == "__main__":
    print("="*80)
    print("RMS ANALYSIS - TREMOR-BRANCH DATASET (Quick Example)")
    print("="*80)
    print("Non-normalized signals for tremor severity estimation")
    print()
    print(f"Parameters:")
